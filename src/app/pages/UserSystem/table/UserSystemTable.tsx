...
import { userSystemColumns } from './columns/_columns'
...
export const UserSystemTable: FC<Props> = ({ namespace }) => {
  const users = useQueryResponseData(namespace)
  ...
  const columns = useMemo<ColumnDef<any>[]>(() => userSystemColumns(namespace), [namespace])
