...
import { ProjectColumns } from './columns/_columns'
...
const ProjectTable: FC<Props> = ({ namespace }) => {
  const Projects = useQueryResponseData(namespace)
  ...
  const columns = useMemo<ColumnDef<any>[]>(() => ProjectColumns(namespace), [namespace])
