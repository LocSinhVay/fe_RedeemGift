...
import { GiftColumns } from './columns/_columns'
...
const GiftTable: FC<Props> = ({ namespace }) => {
  const gifts = useQueryResponseData(namespace)
  ...
  const columns = useMemo<ColumnDef<any>[]>(() => GiftColumns(namespace), [namespace])
