...
import { emailConfigColumns } from './columns/_columns'
...
const EmailConfigTable: FC<Props> = ({ namespace }) => {
  const emailConfigs = useQueryResponseData(namespace)
  ...
  const columns = useMemo<ColumnDef<any>[]>(() => emailConfigColumns(namespace), [namespace])
