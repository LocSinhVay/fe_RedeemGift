...
import { menuColumns } from './columns/_columns'
...
const MenuTable: FC<Props> = ({ namespace }) => {
  const Menus = useQueryResponseData(namespace)
  ...
  const columns = useMemo<ColumnDef<any>[]>(() => menuColumns(namespace), [namespace])
